...
public class LoadingPanel extends JPanel {
	...
	public LoadingPanel(View parent) {
	    ...
	    URL url_select = View.class.getResource("/resources/menu_button_exit_select.png");
		URL url_deselect = View.class.getResource("/resources/menu_button_exit_deselect.png");
